...
EXPNAME="TrackToLearn-Pt-PPO-RLHF"
COMETPROJECT="TrackToLearn-Pt-PPO-RLHF"
EXPID="Pt_PPO_RLHF_Search"_$(date +"%F-%H_%M_%S")
ALG="PPO" #"SACAuto"
...
NPV=2 # Number of points per tractogram for training
SEEDS=(1111)
BATCHSIZE=4096
