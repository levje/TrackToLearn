...
python TrackToLearn/runners/ttl_track.py \
    ...
    "/home/local/USHERBROOKE/levj1404/Documents/TrackToLearn/data/datasets/ismrm2015/masks/ismrm2015_wm.nii.gz" \
    "/home/local/USHERBROOKE/levj1404/Documents/TrackToLearn/data/results/ismrm_streamlines_1.trk" \
    --agent custom_models/ismrm2015_bad_oracle \
    --hyperparameters custom_models/ismrm2015_bad_oracle/hyperparameters.json \
    --min_length 20 \
    --max_length 200 \
    --npv 300 \
    --n_actor 5000 \
