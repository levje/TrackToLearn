...
python TrackToLearn/runners/ttl_track.py \
    ...
    "/home/local/USHERBROOKE/levj1404/Documents/TrackToLearn/data/results/ismrm2015_fullcomplete_tractogram.trk" \
    --agent custom_models/ismrm2015_fullcomplete_oracle \
    --hyperparameters custom_models/ismrm2015_fullcomplete_oracle/hyperparameters.json \
    --min_length 20 \
    --max_length 200 \
    --npv 300 \
    --n_actor 5000 \
